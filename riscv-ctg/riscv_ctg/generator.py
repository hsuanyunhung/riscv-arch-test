...
OPS = {
    ...
    'pbrdrrformat': ['rs1', 'rs2', 'rd'],
    'phrdrrformat': ['rs1', 'rs2', 'rd'],
    'pwrdrrformat': ['rs1', 'rs2', 'rd'],
    'pnnbrrformat': ['rs1', 'rs2', 'rd'],
    'pnnhrrformat': ['rs1', 'rs2', 'rd'],
    'pnnwrrformat': ['rs1', 'rs2', 'rd'],
    'pnnbrdrrformat': ['rs1', 'rs2', 'rd'],
    'pnnhrdrrformat': ['rs1', 'rs2', 'rd'],
    'pnnwrdrrformat': ['rs1', 'rs2', 'rd'],
    'pppbrrformat': ['rs1', 'rs2', 'rd'],
    'ppphrrformat': ['rs1', 'rs2', 'rd'],
    'pppwrrformat': ['rs1', 'rs2', 'rd'],
    'pppdrrformat': ['rs1', 'rs2', 'rd'],
    'ppnbrrformat': ['rs1', 'rs2', 'rd'],
    'ppnhrrformat': ['rs1', 'rs2', 'rd'],
    'ppnwrrformat': ['rs1', 'rs2', 'rd'],
    'ppndrrformat': ['rs1', 'rs2', 'rd'],
    'ppbriformat': ['rs1', 'rd'],
    'pphriformat': ['rs1', 'rd'],
    'ppwriformat': ['rs1', 'rd'],
    'ppdriformat': ['rs1', 'rd'],
...
VALS = {
    ...
    'pbrdrrformat': 'simd_val_vars("rs1", xlen, 8) + simd_val_vars("rs2", xlen, 8) + simd_val_vars("rd", xlen * 2, 16)',
    'phrdrrformat': 'simd_val_vars("rs1", xlen, 16) + simd_val_vars("rs2", xlen, 16) + simd_val_vars("rd", xlen * 2, 16)',
    'pwrdrrformat': 'simd_val_vars("rs1", xlen, 32) + simd_val_vars("rs2", xlen, 32) + simd_val_vars("rd", xlen * 2, 32)',
    'pnnbrrformat': 'simd_val_vars("rs1", xlen, 8) + simd_val_vars("rs2", xlen, 8)',
    'pnnhrrformat': 'simd_val_vars("rs1", xlen, 16) + simd_val_vars("rs2", xlen, 16)',
    'pnnwrrformat': 'simd_val_vars("rs1", xlen, 32) + simd_val_vars("rs2", xlen, 32)',
    'pnnbrdrrformat': 'simd_val_vars("rs1", xlen, 8) + simd_val_vars("rs2", xlen, 8) + simd_val_vars("rd", xlen * 2, 8)',
    'pnnhrdrrformat': 'simd_val_vars("rs1", xlen, 16) + simd_val_vars("rs2", xlen, 16) + simd_val_vars("rd", xlen * 2, 16)',
    'pnnwrdrrformat': 'simd_val_vars("rs1", xlen, 32) + simd_val_vars("rs2", xlen, 32) + simd_val_vars("rd", xlen * 2, 32)',
    'pppbrrformat': 'simd_val_vars("rs1", xlen * 2, 8) + simd_val_vars("rs2", xlen * 2, 8)',
    'ppphrrformat': 'simd_val_vars("rs1", xlen * 2, 16) + simd_val_vars("rs2", xlen * 2, 16)',
    'pppwrrformat': 'simd_val_vars("rs1", xlen * 2, 32) + simd_val_vars("rs2", xlen * 2, 32)',
    'pppdrrformat': 'simd_val_vars("rs1", xlen * 2, 64) + simd_val_vars("rs2", xlen * 2, 64)',
    'ppnbrrformat': 'simd_val_vars("rs1", xlen * 2, 8) + simd_val_vars("rs2", xlen, 32)',
    'ppnhrrformat': 'simd_val_vars("rs1", xlen * 2, 16) + simd_val_vars("rs2", xlen, 32)',
    'ppnwrrformat': 'simd_val_vars("rs1", xlen * 2, 32) + simd_val_vars("rs2", xlen, 32)',
    'ppndrrformat': '["rs1_val"] + simd_val_vars("rs2", xlen, 32)',
    'ppbriformat': 'simd_val_vars("rs1", xlen * 2, 8) + ["imm_val"]',
    'pphriformat': 'simd_val_vars("rs1", xlen * 2, 16) + ["imm_val"]',
    'ppwriformat': 'simd_val_vars("rs1", xlen * 2, 32) + ["imm_val"]',
    'ppdriformat': '["rs1_val"] + ["imm_val"]',
    'ppbrformat': 'simd_val_vars("rs1", xlen * 2, 8)',
    'pphrformat': 'simd_val_vars("rs1", xlen * 2, 16)',
    'ppwrformat': 'simd_val_vars("rs1", xlen * 2, 32)',
    'ppdrformat': '["rs1_val"]',
}
